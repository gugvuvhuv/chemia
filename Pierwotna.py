...
zwiazki_chemiczne = {
    ...
    "Pt": ("platyna","neutralny","metal"),
    "Pd": ("palad","neutralny","metal"),
    "Rb": ("rubid","neutralny","metal"),
    "Sr": ("stront","neutralny","metal"),
    "Cs": ("cez","neutralny","metal"),
    "Ba": ("bar","neutralny","metal"),
    "Fr": ("frans","neutralny","pierwiastek radioaktywny"),
    "Ra": ("rad","neutralny","pierwiastek radioaktywny"),
    "Sc": ("scand","neutralny","metal"),
    "Ti": ("tytan","neutralny","metal"),
    "V": ("wanad","neutralny","metal"),
    "Ga": ("gal","neutralny","metal"),
    "Ge": ("german","neutralny","metal"),
    "Y": ("itr","neutralny","metal"),
    "Zr": ("cyrkon","neutralny","metal"),
    "Nb": ("niob","neutralny","metal"),
    # Cząsteczki
